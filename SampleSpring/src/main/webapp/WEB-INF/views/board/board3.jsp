...
<body>
<form action="board3s" id="saveForm" method="post">
<input type="hidden" name="bm_no" value="${sMemNo}"/>
<table border="1" cellspacing="0">
	<tbody>
		...
		<tr>
			<th>작성자</th>
			<td><input type="text" name="writer" id="writer" readonly="readonly" value="${sMemNm}"/></td>
		</tr>
		<tr>
			<th>내용</th>
